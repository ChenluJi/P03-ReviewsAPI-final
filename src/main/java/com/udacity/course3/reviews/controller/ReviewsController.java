...
//    @Transient
    ...
    public ReviewsController(ReviewRepository reviewRepository, ReviewMongoRepository reviewMongoRepository, ProductRepository productRepository) {
...
//        throw new HttpServerErrorException(HttpStatus.NOT_IMPLEMENTED);
    ...
    public ResponseEntity<List<?>> listReviewsForProduct(@PathVariable("productId") Integer productId) {
        ...
        List<Integer> reviewIDs = reviewRepository.findReviewIDByProductID(product.getProductID());
        List<Review> reviews = (List<Review>) reviewMongoRepository.findAllById(reviewIDs);
